...
public class Ex2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Обработанный массив: " + Arrays.asList(ex.retrieveChangeArr(origin_arr)));
    }

    public <T> T[] retrieveChangeArr (T [] arr) throws MyException {
        T[] result = null;

        for (int i = arr.length-1; i > 0 ; i--) {
            if (arr[i].equals(4)) {
                result = (T[]) new Integer [arr.length-i-1];
